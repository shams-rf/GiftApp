//
//  CustomerCreateAccountForm.swift
//  GiftApp
//
...
struct CustomerCreateAccountForm: View {
    ...
    func saveDetails() {
        ...
        if let currentUser = Auth.auth().currentUser {
            ...
            let path = db.collection("customers").document(currentUser.uid)
...
struct CustomerCreateAccountForm_Previews: PreviewProvider {
    static var previews: some View {
        CustomerCreateAccountForm(formShowing: .constant(Bool(true)))
    }
}
